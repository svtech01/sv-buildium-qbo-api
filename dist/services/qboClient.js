...
export function qboAuthRedirect(_req, res) {
...
export async function qboAuthCallback(req, res) {
...
async function getValidToken() {
    ...
    if (!t)
        throw new Error('No QBO token found. Authorize first.');
    if (dayjs(t.expiresAt).isAfter(dayjs().add(60, 'second')))
...
export async function replayDLQ(req, res) {
